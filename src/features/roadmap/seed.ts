...
const phases = [
  ['p1','التحليل وتثبيت النطاق','تحويل المتطلبات إلى نطاق نهائي ونماذج بيانات ومعايير قبول.',1,2,0,'planned'],
  ['p2','UX/UI + SaaS/PWA','نظام تصميم RTL، التهيئة، لوحة المعلومات وتجربة المنصة على كل الشاشات.',1,4,0,'planned'],
  ['p3','البنية التقنية والأمان','Supabase، المصادقة، الصلاحيات، النشر، المراقبة وسياسات الخصوصية.',1,3,0,'planned'],
  ['p4','دفتر العقارات والملاك','العقارات، الصور، البحث، الوسوم، المفضلة وبيانات الملاك الاحتياطية.',2,5,0,'planned'],
  ['p5','الباحثون والعملاء','ملفات الباحثين والعملاء، المتطلبات، الميزانية والربط الذكي.',3,5,0,'planned'],
  ['p6','القروبات والدعوات','قروبات 1–10 أعضاء، الدعوات، الصلاحيات والمخزون المشترك.',4,7,0,'planned'],
  ['p7','الاشتراكات والدفع','Free / Pro / Group، الحدود، الإضافات وبوابة الدفع داخل المنتج.',5,7,0,'planned'],
  ['p8','المشاركة والخصوصية','رابط عام قابل للإيقاف، واتساب يدوي، وإخفاء بيانات المالك.',4,7,0,'planned'],
...
const tasks = [
  ['t1','p1','اعتماد نطاق الإصدار وخطة القبول',1,0,'planned','critical'],
  ['t2','p1','تثبيت حالات العقار والخصوصية والباقات',1,0,'planned','high'],
  ['t3','p2','Design System عربي RTL والوضع الليلي',2,0,'planned','high'],
  ['t4','p2','Onboarding وشاشة التهيئة',2,0,'planned','medium'],
  ['t5','p3','تهيئة Supabase وRLS وRealtime',2,0,'planned','critical'],
  ['t6','p4','CRUD العقارات والصور والحالات',3,0,'planned','critical'],
  ['t7','p4','البحث والفلاتر والوسوم والمفضلة',3,0,'planned','high'],
  ['t8','p5','ملف الباحث واحتياجاته وميزانيته',4,0,'planned','high'],
  ['t9','p4','تعدد بيانات المالك وأرقام احتياطية',4,0,'planned','medium'],
  ['t10','p8','إخفاء المالك من العرض العام',4,0,'planned','critical'],
  ['t11','p6','إنشاء القروب والدعوات والأدوار',5,0,'planned','high'],
...
export const seedData: RoadmapData = {
  project:{id:P,slug:'aqarati-roadmap',name:'عقاراتي',description:'خارطة تنفيذ تفاعلية لمشروع عقاراتي — عرض مباشر للعميل وإدارة تقدم خاصة بصاحب المشروع.',target_weeks:10,max_weeks:12,total_amount:7800,currency:'SAR',overall_progress:0,current_week:0,start_date:null},
  phases,
  tasks,
  milestones:[
    {id:'m1',project_id:P,title:'اعتماد النطاق',week:1,status:'upcoming',acceptance_summary:'Scope / Backlog ونموذج البيانات معتمد.',sort_order:1},
  ...
  deliverables:[
    ['d1','scope','النطاق النهائي وBacklog ونماذج البيانات',false],['d2','scope','نظام التصميم وتجربة RTL الأساسية',false],
