...
const phases = [
  ...
  ['p2','تجربة الويب SaaS ونظام التصميم','تصميم منصة الويب العربية RTL، لوحة المعلومات، التهيئة، تجربة العميل والإدارة، والوضعين الليلي والنهاري.',1,4,0,'planned'],
  ['p12','تطبيق الهاتف React Native','مسار مستقل لبناء تطبيق Android وiOS فعلي: البنية، التنقل، المصادقة، شاشات العقارات والباحثين، Deep Linking، Push Notifications واختبارات المنصتين.',2,10,0,'planned'],
  ['p3','البنية التقنية والأمان','Supabase، المصادقة، RLS، Realtime، ربط تطبيق React Native، النشر، المراقبة وسياسات الخصوصية.',1,3,0,'planned'],
...
const taskRows = [
  ...
  ['t3','p2','نظام التصميم العربي RTL للويب','توحيد الألوان والخطوط والمكونات وحالات الخطأ والتحميل والوضع الليلي لمنصة الويب ولوحة الإدارة والعرض العام.',2,0,'planned','high','Frontend / Product'],
  ['t4','p2','Onboarding وشاشة التهيئة للويب','تصميم خطوات البداية في منصة الويب لشرح المنتج والباقات والمزايا ومساعدة المستخدم على تجهيز حسابه.',2,0,'planned','medium','Frontend / Product'],
  ...
  ['t19','p12','تهيئة مشروع React Native وبنية التطبيق','إعداد تطبيق الهاتف الحقيقي بهيكل TypeScript حديث ومكونات أصلية وربطه بنظام التصميم المعتمد للمشروع.',2,0,'planned','critical','Mobile'],
  ['t20','p12','تنقل تطبيق الهاتف وDeep Linking','بناء التنقل بين الشاشات ومسارات فتح شاشة محددة من رابط مباشر داخل Android وiOS.',3,0,'planned','high','Mobile'],
  ['t21','p12','مصادقة React Native وربط البيانات مع Supabase','ربط تسجيل الدخول والجلسة وقراءة وكتابة بيانات المستخدم من تطبيق الهاتف مع الالتزام بسياسات RLS.',3,0,'planned','critical','Mobile / Backend'],
  ['t22','p12','شاشات العقارات والباحثين الأساسية في React Native','بناء شاشات الهاتف لإدارة العقارات وعرض التفاصيل والبحث وملفات الباحثين بالوظائف الأساسية المعتمدة.',5,0,'planned','high','Mobile'],
  ['t23','p12','Push Notifications لتطبيق الهاتف','إرسال إشعارات الهاتف للفرص العقارية والتنبيهات المهمة مع فتح الشاشة الصحيحة عند الضغط على الإشعار.',8,0,'planned','high','Mobile / Backend'],
  ['t24','p12','اختبار Android وiOS وتجهيز النسخة المرشحة','اختبار التطبيق على أجهزة Android وiOS فعلية، معالجة اختلافات المنصتين وتجهيز builds مرشحة للإطلاق والتسليم.',10,0,'planned','critical','Mobile / QA'],
]
...
export const seedData: RoadmapData = {
  ...
  milestones:[
    ...
    {id:'m2',project_id:P,title:'Alpha Core',week:5,status:'upcoming',acceptance_summary:'وظائف العقارات والباحثين والقروب الأساسية قابلة للاستعراض على الويب، مع نسخة React Native أساسية قابلة للاختبار.',sort_order:2},
  ...
  deliverables:[
    ['d1','scope','النطاق النهائي وBacklog ونماذج البيانات',false],['d2','scope','نظام التصميم وتجربة RTL للويب',false],
