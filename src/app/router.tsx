...
export const router=createBrowserRouter([
 ...
 {path:'admin',element:<ProtectedRoute><AdminShell/></ProtectedRoute>,children:[{index:true,element:<AdminDashboardPage/>},{path:'tasks',element:<AdminTasksPage/>},{path:'timeline',element:<AdminTimelinePage/>},{path:'payments',element:<AdminPaymentsPage/>},{path:'deliverables',element:<AdminDeliverablesPage/>},{path:'updates',element:<AdminUpdatesPage/>},{path:'settings',element:<AdminSettingsPage/>}]},
